...
Dogfood cases model realistic AGS development workflows, an Enterprise Financial Report Golden Path, a Content Publishing Dogfood Agent, a focused Content Publishing Governance Hardening pack for AGS public-claim agents, and a Decision Closure Hardening case for incomplete execution-boundary proof. Red-team cases model adversarial bypass attempts. None of these evals execute real actions.
